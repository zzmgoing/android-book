...
<img src="https://img.upyun.zzming.cn/android-book/activity.png" width = "644.4" height = "793.8"  alt=""/>
...
![standard](https://img.upyun.zzming.cn/android-book/activity_standard)
#### 栈顶复用模式**SingleTop** {docsify-ignore}
![singleTop](https://img.upyun.zzming.cn/android-book/activity_singleTop)
#### 栈内复用模式**SingleTask** {docsify-ignore}
![singleTask](https://img.upyun.zzming.cn/android-book/activity_singleTask)
#### 全局唯一模式**SingleInstance** {docsify-ignore}
![singleInstance](https://img.upyun.zzming.cn/android-book/activity_singleInstance)
...
<img src="https://img.upyun.zzming.cn/android-book/service.png" alt="" align=center />
...
![content](https://img.upyun.zzming.cn/android-book/content.jpg)
